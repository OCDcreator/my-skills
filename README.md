...
| 技能 | 说明 |
|------|------|
| [syncthing](custom/devops/syncthing/) | Syncthing 同步排障、Windows/macOS 保留名、`.stignore` 顺序与官方 REST API 诊断 |
...
| 脚本 | 说明 |
|------|------|
| `update.sh` / `update.bat` | 从 8 个外部源拉取最新技能到 `external/` → 自动 commit & push |
