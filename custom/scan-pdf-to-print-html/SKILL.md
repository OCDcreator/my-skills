...
- `scripts/validate_rendered_handout_contract.py` — browser-DOM rendered-output gate for blockquote lead badges and computed left accent rule (including flattened-border regression coverage), neutral question option tables, readable choice images, overflow, contentless sheets, marked cover-vs-regular sheet screen alignment, and optional final KaTeX/MathJax checks via `--require-katex --disallow-mathjax` <!-- evolved 2026-06-20; strengthened 2026-06-22 -->
