...
If the environment includes `knowledge-to-print-html`, hand off to it using the finished transcript and a strict fidelity brief.

If `knowledge-to-print-html` is unavailable, build the HTML directly with these rules:
