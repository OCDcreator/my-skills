...
- **SVG inner padding / SVG 内边距** — compact SVG text boxes and medium structured frames must keep healthy inner padding, avoid text or child boxes hugging the bottom edge, and keep spacing in visual balance
...
- a compact SVG text box or medium structured frame technically fits but still looks broken because its inner padding is too tight or visually unbalanced
