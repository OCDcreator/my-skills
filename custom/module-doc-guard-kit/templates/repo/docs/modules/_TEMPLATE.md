...
List key exports, classes, functions, constants, or types.
...
Describe how data enters, is transformed, and leaves this module. Write “Not applicable” for pure type or constant modules.

## Interactions

Name the modules or systems that must stay in sync with this one.
