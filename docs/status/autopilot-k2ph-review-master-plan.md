...
- Follow the first `[NEXT]` queue item in `docs/status/autopilot-k2ph-review-round-roadmap.md`
- Stay inside pages 4-6 of the salts handout
- Re-run the page review packet before and after edits
- Do not widen scope to other skills or unrelated repo work
